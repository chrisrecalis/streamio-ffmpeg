...
module FFMPEG
  class Movie
    ...
    def transcode(output_file, options = EncodingOptions.new, transcoder_options = {}, input_options = "", &block)
      Transcoder.new(self, output_file, options, transcoder_options, input_options).run &block
    end
